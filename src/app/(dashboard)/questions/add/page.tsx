...
export default function AddQuestionPage() {
  ...
  useEffect(() => {
    if (!exerciseId || !questionId) {
      toast({
        title: "Lỗi",
        description: "Thiếu thông tin bài tập hoặc câu hỏi",
        variant: "destructive",
      })
      router.push("/dashboard/exercises")
    }
  }, [exerciseId, questionId, router])
  ...
  const handleExit = () => {
    if (question.content || question.solution || question.guide || question.images.length > 0) {
    ...
    <div className="space-y-6">
      <div className="flex items-center justify-between bg-card p-4 rounded-lg shadow-sm sticky top-0 z-10">
        <div className="flex items-center gap-2">
          ...
          <h1 className="text-3xl font-bold">Thêm câu hỏi mới</h1>
        </div>
        ...
        <Card className="border-primary/20 shadow-md overflow-hidden">
          ...
          >
            <div className="flex-1">
              ...
              <CardDescription>Nhập nội dung và loại câu hỏi</CardDescription>
            </div>
